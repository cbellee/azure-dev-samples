...
type AccountsService interface {
	...
	GetAccount(ctx context.Context, in *common.InvocationEvent) (out *common.Content, err error)
	AddAccount(ctx context.Context, in *common.InvocationEvent) (out *common.Content, err error)
